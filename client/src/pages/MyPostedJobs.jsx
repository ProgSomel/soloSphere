...
const MyPostedJobs = () => {
  ...
  const getData = async()=> {
    const {data} = await axios(`${import.meta.env.VITE_API_URL}/jobsByBuyer/${user?.email}`, {withCredentials: true});
    setPostedJobs(data);
  }
  ...
  const handleDelete = async (id) => {
    ...
    try{
      await axios.delete(`${import.meta.env.VITE_API_URL}/jobs/deleteAJob/${id}`);
